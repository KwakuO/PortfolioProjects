...
Skills used: ROUNDING , ALIASES, ORDERING, CONDITIONAL FILTERING DIRECT COMPARISONS, CREATING TABLES, 
AGGREGATION FUNCTIONS, JOINING CONDITIONALS, INNER JOIN, FILTERING AGGREGATIONS, LOGIC STATEMENTS
